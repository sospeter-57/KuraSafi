...
export default function VoterLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/3 w-80 h-80 bg-accent rounded-full opacity-[0.05] blur-3xl pointer-events-none" />

      <div className="relative z-10 w-full max-w-md animate-slide-up">
        <div className="mb-8 flex items-center justify-between">
          <Link to="/" className="text-muted hover:text-white text-sm transition-colors">← Back</Link>
          <Link to="/voter/register" className="text-accent text-sm hover:underline">Register →</Link>
        </div>
        ...
        <div className="card border-accent border-opacity-30">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="font-display font-bold text-xl text-accent">Voter Login</h2>
              <p className="text-muted text-xs">Authenticate to cast your vote</p>
            </div>
          </div>
